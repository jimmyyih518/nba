...
month = month_link_array[5][0]
page = month_link_array[5][1]  

statdf = getMonthdata(month, page)
outfile = str(season) + str(month)
statdf.to_csv(f'D:/JZR/nba/{outfile}.csv')
